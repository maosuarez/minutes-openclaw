...
This repo is a thin TypeScript adapter — all transcription logic lives in the `minutes` binary from the parent project. See `../minutes/AGENTS.md` for the full CLI architecture.
